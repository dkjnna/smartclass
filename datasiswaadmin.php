...
?>
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $query_siswa_admin = "SELECT * FROM data_siswa WHERE id_kelas = '$id_kelas'";
$result_siswa_admin = mysqli_query($koneksi, $query_siswa_admin);// Pastikan koneksi ke database telah dibuat
        ?>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
    $id = 1;
    while ($row_siswa_admin = mysqli_fetch_assoc($result_siswa_admin)) {
        echo "<tr>";
        echo "<td>" . $id++ . "</td>";
        echo "<td>" . $row_siswa_admin['nama'] . "</td>";
        echo "<td>" . $row_siswa_admin['nisn'] . "</td>";
        echo "<td>" . $row_siswa_admin['nik'] . "</td>";
        echo "<td>" . $row_siswa_admin['alamat'] . "</td>";
        echo "<td>" . $row_siswa_admin['no_hp'] . "</td>";
        echo "<td>" . $row_siswa_admin['no_rumah'] . "</td>";
