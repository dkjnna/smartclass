...
<meta charset="utf-8">
    ...
    <title>Smart Class | Profil Admin</title>
...
<div class="card-body login-card-body">
                <p class="login-box-msg">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Soluta, quos!</p>
                <div class="card">
                    <div class="card-body login-card-body">
                        <table class="table">
                            <thead>
...
<div class="content-wrapper">
  ...
  <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  <thead>
                    <tr>
                      ...
                      <th style="background-color:#FCD900">Telepon Rumah</th>
                      <?php
                      if (isAdminLoggedIn()) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if (isAdminLoggedIn()) {
                        // Jika pengguna sudah login sebagai admin, tampilkan tombol aksi
                        displayActionButtons($row['id']);
                    }
    echo "</tr>";
                }
                ?>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="indexl.html" class="nav-link">Beranda</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" data-widget="login" href="profil.php" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #001E6C;">
    ...
    <div class="sidebar" style="background-color: #001E6C;">
      ...
      <div class="form-inline">
        <div class="input-group" data-widget="sidebar-search" style="background-color: #f5f5f5;">
          <input class="form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search" style="background-color: #f5f5f5; color:#000;">
          <div class="input-group-append">
            <button class="btn btn-sidebar" style="background-color:#f5f5f5;">
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        $result = mysqli_query($koneksi, $query); // Pastikan koneksi ke database telah dibuat
        ?>

            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Siswa XI RPL 2</h3>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Check if admin is logged in (you should implement this logic on the server-side)
    var isAdminLoggedIn = false; // Change this with your actual logic

    userBtn.addEventListener('click', function () {
        if (isAdminLoggedIn) {
            // Replace the following lines with your logic to retrieve admin data
            var adminData = {
                name: 'Admin Name',
            ...
            nameElement.textContent = 'Name: ' + adminData.name;
            usernameElement.textContent = 'Username: ' + adminData.username;
            passwordElement.textContent = 'Password: ' + adminData.password;
    ...
    logoutBtn.addEventListener('click', function () {
        // Implement your logout logic here (e.g., destroy session)
        // ...
