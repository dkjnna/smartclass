    ...
    <button class="btn btn-secondary" onclick="togglePopup()">Kembali</button>
            ...
            <div class="lockscreen-wrapper" >
                <div class="lockscreen-logo" >
                  <a href="#" style="font-weight: 900; font-size:30px;"><b>Welcome to</b> Smart Class</a>
                  <p style="font-size: 15px;">Memberdayakan pikiran, mengubah masa depan</p>
                </div>
                <!-- User name -->
                ...
                <div class="lockscreen-item" style="padding-right: -2000px; float: right; margin-top: 10px;">
                  <!-- lockscreen image -->
                  <div class="lockscreen-image" >
                    <img src="logo.png" alt="User Image" style="width: 200px; height: 200px; z-index: 100; ">
                  </div>
                  <!-- /.lockscreen-image -->
